...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <GlowOrb className="w-[300px] h-[300px] bg-emerald-500/[0.04] bottom-0 left-0" />
      ...
      >
        ...
        <div className="relative bg-black/80 backdrop-blur-xl border border-white/[0.08] rounded-2xl overflow-hidden">
          ...
          <div className="flex items-center gap-2 px-5 py-3.5 border-b border-white/[0.06]">
            ...
            <span className="ml-3 text-xs text-neutral-600 font-mono">auth/register</span>
          </div>

          <div className="p-8">
            <div className="mb-8">
              <h1 className="text-2xl font-bold text-white tracking-tight">Create account</h1>
              <p className="text-sm text-neutral-500 mt-1.5">Start your security journey</p>
            </div>
